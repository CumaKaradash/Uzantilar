// Popup: hızlı ayarlar. Değişiklikleri chrome.storage.sync'e yazar ve açık YouTube sekmelerine uygulatır.
...
function bindAutoSave() {
  document.querySelectorAll('input[type="checkbox"]').forEach((input) => {
    input.addEventListener('change', async () => {
      ...
      // Aktif YouTube sekmesine haber ver; içerik betiği ayarları uygulasın
...
// Harici bağlantılar (URL'leri istediğin zaman güncelle)
...
function updateTexts(lang) {
  const dict = {
    tr: {
      ...
      hideHome: 'Anasayfa önerileri',
      hideWatchRecommended: 'Video yanı/altı öneriler',
      hideShorts: 'Shorts videoları ve sekmeleri',
      hideComments: 'Yorumlar bölümü',
      hideEndScreen: 'Videonun sonundaki öneri kartları',
      footer: 'Cuma Karadash tarafından geliştirildi',
      bmc: 'Bir kahve ısmarla'
    },
    en: {
      header: 'Focus Settings',
      hideHome: 'Homepage recommendations',
      hideWatchRecommended: 'Watch page side/below recommendations',
      hideShorts: 'Shorts videos and tabs',
      hideComments: 'Comments section',
      hideEndScreen: 'End-screen suggestion cards',
  ...
  setLabel('hideHome', dict.hideHome);
  setLabel('hideWatchRecommended', dict.hideWatchRecommended);
  setLabel('hideShorts', dict.hideShorts);
  setLabel('hideComments', dict.hideComments);
  setLabel('hideEndScreen', dict.hideEndScreen);
