// Servis çalışanı (Manifest V3) - Instagram SPA URL değişimlerini dinler
...
// Instagram SPA: history.pushState ile sayfa değiştiğinde tetiklenir
chrome.webNavigation.onHistoryStateUpdated.addListener(async (details) => {
  try {
    // Yalnızca Instagram alanları için
